    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_scan_wifi:
                ...
                stringBuilder.append("网络名称：" + wifiInfo.getSSID());
                stringBuilder.append("  地址：" + wifiInfo.getBSSID());
                stringBuilder.append("  强度：" + wifiInfo.getRssi());
                stringBuilder.append("\n\n");

                for (ScanResult scanResult : wifiControlUtils.getWifiList()) {
                    stringBuilder.append("网络名称：" + scanResult.SSID);
                    stringBuilder.append("  地址：" + scanResult.BSSID);
